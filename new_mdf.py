...
###############################################################################
def main():
    data_path = "/home/user16/HT/VideoTree/data/egoschema/fullset_anno.json"
    frame_root = "/home/user16/HT/VideoTree/egoschema_features"
    ...
    for vf in tqdm(video_list):
        ...
        embeddings = torch.load(emb_path)  # [T, dim]
        T = embeddings.size(0)
    ...
    # 최종 저장
    out_path = "/home/user16/HT/VideoTree/new/mdf_sampled_frames_localminmax.json"
